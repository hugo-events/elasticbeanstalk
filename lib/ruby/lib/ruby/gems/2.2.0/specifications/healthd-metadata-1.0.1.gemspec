# -*- encoding: utf-8 -*-
# stub: healthd-metadata 1.0.1 ruby lib

Gem::Specification.new do |s|
  s.name = "healthd-metadata"
  s.version = "1.0.1"
  ...
  s.date = "2016-05-03"
  s.description = "EC2 metadata collector for Beanstalk Health"
  ...
  s.summary = "Beanstalk Health Metadata Plugin for Linux"
